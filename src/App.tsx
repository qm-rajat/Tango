  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://images.pexels.com/photos/6147366/pexels-photo-6147366.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')"
        }}
      ></div>
      ...
      {/* Main Content */}
      <main className="relative z-20 flex flex-col justify-between min-h-screen pt-8">
          ...
          <div className="text-center max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <div className="flex items-center space-x-3">
                <button className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-200 shadow-lg">
